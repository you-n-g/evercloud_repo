...
URL = 'http://192.168.1.20:8081/login'
...
# Authenticate
login_data = dict(username='user2', password='123qweASD', csrfmiddlewaretoken=csrftoken, next='/')
...
# Get instances
instances_return = client.get("http://192.168.1.20:8081/api/instances/vdi/")
