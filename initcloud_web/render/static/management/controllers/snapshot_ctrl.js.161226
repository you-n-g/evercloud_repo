...
CloudApp.controller('SnapshotController',
    function($rootScope, $scope, $filter, $modal, $i18next, $ngBootbox,
        ...
        $scope.openNewSnapshotModal = function(){
            $modal.open({
    ...
    .controller('NewSnapshotController',
        function($scope, $modalInstance, $i18next,
                 CommonHttpService, ToastrService, SnapshotForm, dataCenters){
            ...
            $scope.create = function(){
                ...
                CommonHttpService.post('/api/snapshot/create/', $scope.snapshot).then(function(result){
                    if(result.success){
