...
#@memoized
def glanceclient(request, url, version='1'):
    ...
    keystone = v2_0.client.Client(username = request.get('username'), password = request.get('password'),auth_url = request.get('auth_url'), tenant_name = request.get('tenant_name'))
