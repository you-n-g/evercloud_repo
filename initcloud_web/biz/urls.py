...
urlpatterns += [
    ...
    url(r'^snapshot/is_snapshotname_unique/$', snapshot_view.is_snapshotname_unique),
]

#ceilometer
urlpatterns += [
    #url(r'^ceilometer/$', ceilometer_view.CeilometerList.as_view()),
    url(r'^ceilometer/$', ceilometer_view.return_kibana),
...
urlpatterns += [
    ...
    url(r'^instances/batch_create/$', instance_view.instance_batch_create_view),
...
urlpatterns += format_suffix_patterns([
    ...
    url(r'^operation/collector/$', account_view.collector_operation),
...
urlpatterns += format_suffix_patterns([
    ...
    url(r'^account/update/$', account_view.update_user),
    url(r'^account/tenants/$', account_view.tenants_list.as_view()),
    url(r'^account/is-name-unique/$', account_view.is_username_unique),
    url(r'^account/is-email-unique/$', account_view.is_email_unique),
    url(r'^account/is-mobile-unique/$', account_view.is_mobile_unique),
    url(r'^account/user-mobile/$', account_view.get_user_mobile),
    url(r'^account/update-name-unique/$', account_view.update_username_unique),
    url(r'^account/update-email-unique/$', account_view.update_email_unique),
    url(r'^account/update-mobile-unique/$', account_view.update_mobile_unique),
    url(r'^operation/$', account_view.OperationList.as_view()),
    url(r'^operation/filters$', account_view.operation_filters),
