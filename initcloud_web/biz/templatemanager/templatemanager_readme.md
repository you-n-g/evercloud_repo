...
1.各个文件的说明
   ...
   templatemanager_ctrl.js: 具体处理各项前端请求的js代码，所有的操作从这里发起。

   templatemanager.html: 具体模版 
...
3.部署应用
        ...
        比如:
         ...
         <li>
            <a href="#/templatemanager/">
                ...
                <span class="title">
                    {[{ 'sidebar.templatemanager' | i18next }]}
                </span>
   ...
   j.add app in settings
      ...
      比如应用的名称是templatemanager,则添加biz.templatemanager
...
INSTALLED_APPS = [
   ...
   k.migrate app
     ...
     ./makemigrations.sh templatemanager 
